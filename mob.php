<!DOCTYPE html>
<html>
    <head><title> SMART CATCHERS</title>
...
<a href="https://api.whatsapp.com/send?phone=+919767517147&text=Hii%20i%20want%20Service%20from%20Smartcathchers%20" class="float"  target="_blank">
...
<!-- partial -->
        ...
        <div class="bgimg" >
            <nav class="navbar navbar-expand-md bg-dark navbar-dark  fixed-top">
                <div class="container">
                    <a href="" class="navbar-brand text-warning font-weight-bold">SMART CATCHERS</a>
               ...
               <div class="collapse navbar-collapse " id="collapsenavbar">
                   <ul class="navbar-nav ml-auto">
                       ...
                       <li class="navbar-item "> 
                            <a href="#abtus" class="nav-link text-white">ABOUT US</a>
                        </li>
                        <li class="navbar-item  "> 
                                <a href="" class="nav-link js-scroll-trigger text-white">CONTACT</a>
                            </li>
                            <li class="navbar-item "> 
                                    <a href="" class="nav-link js-scroll-trigger text-white">PROFILES</a>
                                </li>
                   </ul>
            ...
            <div class="container text-center harderset" >
                <h1 >Mobile Repairing</h1>
                <H2>Save your valuable time with SMARTCATHRES </H2>
            </div>
                <div class="wrap">
                    <a href="#" id="button" class="button">
                <button  class="button1">Book Now</button> </a>
                </div>
<!--popup model-->
                <div class="bg-modal">
...
document.querySelector('.close').addEventListener("click", function() {
	document.querySelector('.bg-modal').style.display = "none";
        ...
        <div class="container-fluid" id="bg3">
            <footer class="container " id="abtus">
          <div class="row foot">
        ...
        <h5 style="border-bottom:0px;"><span class="glyphicon glyphicon-chevron-right"></span><a href="#" class="text-muted"><b> Conatct Us</b></a></h5>
            ...
            <div id="foot3" class="col-md-3 col-sm-3" >
                <h3>Address</h3>
                <h4 class="text-muted">Shivaji Nagar<br>juna Tofkhana, Near Civil Court<br>Pune 411005 </br>E-mail: SmartCatchers@gmail.com</h4>
              ...
              <div id="foot4" class="col-md-3 col-sm-3">
                 <h3>Follow Us</h3><br>
                   <ul class="social-network social-circle">
                      ...
                      <li><a href="#" class="icoTumblr" title="instagram"><i class="fa fa-instagram"></i></a></li>
        ...
        <section class="container-fluid" id="foot5">
                <h6 class="text-center text-muted ">Copyrights © 2019 SmartCatchers.com</h4>
              </section>
    ...
    function revealOnScroll() {
     ...
     $(".revealOnScroll.animated").each(function (index) {
        var $this     = $(this),
            offsetTop = $this.offset().top;
        if (scrolled + win_height_padded < offsetTop) {
          $(this).removeClass('animated fadeInUp flipInX lightSpeedIn tada')
        }
      });
    }
